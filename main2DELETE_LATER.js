// TO DO:  Update the keypress code to match the mouseClick code
// QUIZ KEY PRESS
document.addEventListener("keydown", logKey);
function logKey(e) {
  switch (e.keyCode) {
    case 13: // "ENTER/RETURN" keypress
      if (isAnswerBoxClicked === true) {
        ...
        if (questionNumber < quizData.length) {
          ...
          alert("ADD CODE LATER - QUIZ COMPLETE!");
        }
      }
      break;
    case 49: // "1" keypress
      q_answer1.style.backgroundColor = "#58cc02"; // FEATHER GREEN
    ...
    case 50: // "2" keypress
      ...
      q_answer2.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      q_answer3.style.backgroundColor = "#f7f7f7"; // POLAR
      q_answer4.style.backgroundColor = "#f7f7f7"; // POLAR
      q_checkButton.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      q_checkButton_text.style.backgroundColor = "#58cc02"; // FEATHER GREEN
    ...
    case 51: // "3" keypress
      q_answer1.style.backgroundColor = "#f7f7f7"; // POLAR
      q_answer2.style.backgroundColor = "#f7f7f7"; // POLAR
      q_answer3.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      q_answer4.style.backgroundColor = "#f7f7f7"; // POLAR
      q_checkButton.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      q_checkButton_text.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      isAnswerBoxClicked = true;
    ...
    case 52: // "4" keypress
      ...
      q_answer2.style.backgroundColor = "#f7f7f7"; // POLAR
      q_answer3.style.backgroundColor = "#f7f7f7"; // POLAR
      q_answer4.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      q_checkButton.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      q_checkButton_text.style.backgroundColor = "#58cc02"; // FEATHER GREEN
      isAnswerBoxClicked = true;
      break;
